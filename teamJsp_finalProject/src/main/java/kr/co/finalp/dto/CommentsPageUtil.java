...
public class CommentsPageUtil {
	...
	public static Map<String, Object> getTotal(int totalNumber,int commentno){
		Map<String, Object> map = new HashMap<String, Object>();
		
		boolean prev = commentno > 1 ? true:false;
		boolean next = commentno+1 > totalNumber ? false : true;
